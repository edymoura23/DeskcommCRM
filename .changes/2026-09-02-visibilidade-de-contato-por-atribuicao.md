...
Até agora, quem tem o papel "atendente" (agent) enxergava **todos os contatos da organização**
— nome, telefone, e-mail, CPF, data de nascimento — pela tela de
...
Junto vem uma trava na atribuição de conversas: um atendente comum **não consegue mais "assumir" pela fila**
uma conversa que ainda não é dele — nem uma
...
Se a sua operação depende de os atendentes **pegarem conversas sozinhos de uma fila aberta**,
escolha uma destas opções antes de atualizar:
