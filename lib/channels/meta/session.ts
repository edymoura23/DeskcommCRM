 ...
 * porque nome de provider fora de `lib/channels/` viola o invariante 1; e existe
 * como interface própria para não obrigar a sessão do webhook, que não usa o
 * número, a carregar um campo que ela nunca preenche.
 */
